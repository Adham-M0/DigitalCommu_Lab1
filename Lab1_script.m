...
% Compute the BER
BER_case_1 = ComputeBER(bit_seq,rec_bit_seq,N_bits); % IMPLEMENT THIS: Calculate the bit error rate
...
for p_ind = 1:length(p_vect)
    ...
    rec_bit_seq = DecodeBitsFromSamples(rec_sample_seq,'part_1',p);
    BER_case_1_vec(p_ind) = ComputeBER(bit_seq,rec_bit_seq,N_bits);
end
%%%
